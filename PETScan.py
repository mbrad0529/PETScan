...
parser.add_argument("-o", "--output", help="Output file to write results to, default is report.txt", nargs="?",
                    dest="outfile", action="store", default="report.txt", const="report.txt")
